...
from .views import EncuestaView,PreguntaView,RespuestaView,EncuestaCompleta,TraerEncuestasID,EncuestasRespondidasSinResponderView,CambiarEstadoEncuestaView,EncuestaCompletaEmpresa
...
urlpatterns = [
    ...
    path("encuestas-respondidas-empresa/<int:empresa>/", EncuestaCompletaEmpresa.as_view())
]

...
from . import views
from .views import CambiarEstadoEmpresaView, CambiarRolUsuarioView, AsignarEmpleadosEmpresasView,TraerEmpleadosEmpresaView,TraerAreasTrabajoEmpresaView,ObtenerIDEmpresaView
urlpatterns = [

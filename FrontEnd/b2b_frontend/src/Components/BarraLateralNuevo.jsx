            ...
            <div className="barra-lateral">
                ...
                <div className="barra-lateral-menu">
                    <ul className="barra-lateral-menu-lista">
                        <li className="barra-lateral-menu-icono"><MdDashboard className="me-3" size={25} /></li>
                        <li className="barra-lateral-menu-icono"><RiSurveyFill className="me-3" size={25} /></li>
                        <li className="barra-lateral-menu-icono"><IoMdBusiness className="me-3" size={25} /></li>
                        <li className="barra-lateral-menu-icono"><ImProfile className="me-3" size={25}/></li>
